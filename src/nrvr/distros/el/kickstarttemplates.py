...
class ElKickstartTemplates(object):
    ...
    # a kickstart file template known to work well with Scientific Linux 6.1 (tested up to 6.5)
...
@java-platform
@large-systems
# @misc-sl only if Scientific Linux
# see ftp://ftp.scientificlinux.org/linux/scientific/6.5/i386/os/repoview/misc-sl.group.html
#@misc-sl
...
""".splitlines())
    ...
    # list of packages and package groups from CentOS 6.5 (generated by anaconda)
    # for creating generally usable workstations
    #
    # to boot into graphical login use with kickstart command
    # xconfig --startxonboot
    #
    # some chance it will work with other brand Enterprise Linux distributions
    packagesOfCentOS65Desktop = filter(None, """
@base
@core
@debugging
@basic-desktop
